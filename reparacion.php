...
<link rel="stylesheet" type="text/css" href="fonts.css">
	...
	<title>Reparación - Flores Escobar</title>
</head>
<body>
<header id="mainHeader">
    ...
    <div id="container">
                <img src="images/banner_repa.png" id="banner_container">
<section id="cursos">
...
?>  ">
		<p><?php 
$data = mysql_query("select nameProducto from autoproducto where idProducto='001' and estadoProducto='REPARACION'");
...
<img width="150px" height="100px" src="                                
<?php 
$data = mysql_query("select urlProducto from imgproducto where idProducto='' and idImg=''");
while($nt=mysql_fetch_array($data)){ $urlProducto=nl2br($nt['urlProducto']);
echo "$nt[urlProducto]";    
}
?>  ">
		<p><?php 
$data = mysql_query("select nameProducto from autoproducto where idProducto=''");
while($nt=mysql_fetch_array($data)){ $nameProducto=nl2br($nt['nameProducto']);
echo "<p>$nt[nameProducto]</p>";   
}?>  </p>
