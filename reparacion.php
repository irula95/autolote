...
<img id="logo" src="images/banner.png" />
	...
	<li><a href="#">Marcas</a>
			<ul>
			   ...
			   <li><a  href="#"><img src="images/logos/bmw_icon.png" height="28px" width="28px"/>BMW</a></li>
			   <li><a href="#">CHEVROLET</a></li>
			 <li><a  href="#"><img src="images/logos/ford_icon.png" height="28px" width="28px"/>FORD</a></li>
			   <li><a href="#">GMC</a></li>
			   <li><a href="#">HONDA</a></li>
			   <li><a href="#"><img src="images/logos/hyundai_icon.png" height="28px" width="28px"/>HYUNDAI</a></li>
			   <li><a href="#"><img src="images/logos/kia_icon.png" height="28px" width="28px"/>KIA</a></li>
			   <li><a href="#">MAZDA</a></li>
			   <li><a href="#">MITSUBISHI</a></li>
			   <li><a href="#"><img src="images/logos/nissan_icon.png" height="28px" width="28px"/>NISSAN</a></li>
			   <li><a href="#">SUZUKI</a></li>
			   <li><a href="#"><img src="images/logos/toyota_icon.png" height="28px" width="28px"/>TOYOTA</a></li>
...
echo "<p>$nt[nameProducto]</p>";   
	...
	<article>
		<img src="images/repa/auto3.jpg" alt="honda" width="150px" height="110px" />
		<p>Toyota Yaris 2008</p>
	</article>
	<article>
		<img src="images/repa/auto4.jpg" alt="bmw" width="150px" height="110px" />
		<p>Hyundai Elantra 2013</p>
	</article>
	<article>
		<img src="images/repa/auto5.jpg" alt="HTML5" width="150px" height="110px" />
		<p>Nissan Versa 2010</p>
		
	</article>
	<article>
		<img src="images/repa/auto6.jpg" alt="HTML5" width="150px" height="90px" />
		<p>Nissan Versa 2009</p>

	</article>
	<article>
		<img src="images/repa/auto7.jpg" alt="HTML5" width="150px" height="110px" />
	<p>Honda Odyssey 2008</p>
	</article>
	<article>
		<img src="images/repa/auto8.jpg" alt="HTML5" width="150px" height="110px" />
		<p>Honda Civic LX 2012</p>
	</article>
	<article>
		<img src="images/repa/auto9.jpg" alt="HTML5" width="150px" height="110px" />
		<p>Hyundai Elantra 2013</p>
	</article>
	<article>
		<img src="images/repa/auto10.jpg" alt="HTML5" width="150px" height="110px" />
		<p>Pontiac Vibe 2009</p>
	</article>
...
Crear un valor agregado a nuestros productos y servicios a través de la plena satisfacción de nuestros clientes, convirtiéndonos de esta manera en una empresa sólida y confiable, teniendo en cuenta lo más importante de nuestra razón de ser: El Cliente.
	...
	<section id="popular">
		...
		<ul>
			...
			<li><a href="pandora.html">Quienes Somos?</a></li>
			<li><a href="tiffany.html">Contactenos</a></li>
		</ul>
	</section>
