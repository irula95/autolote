...
$data = mysql_query("select precioProducto from autoproducto where idProducto='002'");
...
<?php 
$data = mysql_query("select nameProducto from autoproducto where idProducto='002'");
...
<?php 
$data = mysql_query("select anoProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Kilometros</p>
    ...
    <?php 
$data = mysql_query("select kmProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Transmision</p>
    ...
    <?php 
$data = mysql_query("select transmisionProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Tipo de Combustible</p>
       ...
       <?php 
$data = mysql_query("select gasProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Tracción</p>
          ...
          <?php 
$data = mysql_query("select traccionProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Capacidad</p>
     ...
     <?php 
$data = mysql_query("select capacidadProducto from autoproducto where idProducto='002'");
...
<p id="info_titulo">Puertas</p>
       <?php 
$data = mysql_query("select puertasProducto from autoproducto where idProducto='002'");
...
echo "<p='info_detalles'>$nt[puertasProducto]</p>";    
       ...
       <?php 
$data = mysql_query("select descripcionProducto from autoproducto where idProducto='002'");
